...
-- CreateIndex
CREATE INDEX "scraps_userId_createdAt_idx" ON "scraps"("userId", "createdAt");

-- CreateIndex
CREATE INDEX "scraps_jobPostId_idx" ON "scraps"("jobPostId");

-- CreateIndex
CREATE UNIQUE INDEX "scraps_userId_jobPostId_key" ON "scraps"("userId", "jobPostId");
...
-- AddForeignKey
ALTER TABLE "scraps" ADD CONSTRAINT "scraps_jobPostId_fkey" FOREIGN KEY ("jobPostId") REFERENCES "job_posts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
